        ...
        <div class="hero__featured-card">
          ...
          <div class="featured-card__content">
            ...
            <p class="featured-card__desc">
              He’s talking tough on clergy sexual abuse, or is he just another pervert protector? (thumbs down) or a
              true pedophile punishing pontiff? (thumbs up)
            </p>
            <p class="featured-card__more-info">
              <a href="http://wikipedia.com">
                <svg class="featured-card__more-info-icon" preserveAspectRatio="true" xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 27 18">
                  <path
