      ...
      <div class="hero__featured-card">
        ...
        <div class="featured-card__content">
          ...
          <p class="featured-card__desc">
            He’s talking tough on clergy sexual abuse, or is he just another pervert protector? (thumbs
            down) or a true pedophile punishing pontiff? (thumbs up)
          </p>
          <p class="featured-card__more-info">
            <a href="http://wikipedia.com">
              <svg class="featured-card__more-info-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 18">
                <path
    ...
    <aside class="banner banner-top" role="doc-tip" aria-label="Speak Out">
      ...
      <div class="banner__right">
        <p class="banner__text">
          Rule of Thumb is a crowd sourced court of public opinion where anyone and everyone can speak out and
